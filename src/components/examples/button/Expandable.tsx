...
const MenuItems = () => {
  return (
    <NavList>
      <li>
        <NavLink href="https://corp.freee.co.jp/company/">会社概要</NavLink>
      </li>
      <li>
        <NavLink href="https://corp.freee.co.jp/mission/">ミッション</NavLink>
      </li>
      <li>
        <NavLink href="https://corp.freee.co.jp/news/">ニュース</NavLink>
      </li>
    </NavList>
  );
};
...
const BadHamburgerMenu: React.FC = () => {
  ...
  return (
    <HamburgerStyle>
      <MyButton type="button" className="button" onClick={handleClick}>
        <Svg
          xmlns="http://www.w3.org/2000/svg"
          height="48"
          viewBox="0 96 960 960"
      ...
      <div className={`hamburgermenu${isExpanded ? ' expanded' : ''}`}>
        <MenuItems />
      </div>
    </HamburgerStyle>
  );
