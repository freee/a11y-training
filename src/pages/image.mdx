...
import { IconWrapper } from '/src/components/parts/IconWrapper';
...
<ExampleContainer>
  <h4><IconWrapper><MdLightbulb aria-hidden="true" /></IconWrapper>毎日のルーティンを見直して新しい自分を発見しましょう！</h4>
</ExampleContainer>
...
<ExampleContainer>
  <div style={{background: '#fff', padding: '0.75rem', width: 'fit-content'}}>
    <span style={{fontSize: '1.5rem', fontWeight:'bold', fontFamily:"'Noto Sans JP', sans-serif"}}>NVDA でアクセシビリティ チェック</span>
  </div>
</ExampleContainer>
...
<ExampleContainer>
  <img alt="NVDAでアクセシビリティ チェック" src={publicPath('nvdaa11ycheck.png')} width={417} height={56} />
</ExampleContainer>
...
<ExampleContainer>
  <img alt="VoiceOver でアクセシビリティ チェック" src={publicPath('nvdaa11ycheck.png')} width={417} height={56} />
</ExampleContainer>
